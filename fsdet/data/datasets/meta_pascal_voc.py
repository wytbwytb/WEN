...
def load_filtered_voc_instances(
    ...
    if is_shots:
        fileids = {}
        split_dir = os.path.join("/media/datasets/PascalVOC_outline/VOCdevkit", "vocsplit")
    ...
    if is_shots:
        for cls, fileids_ in fileids.items():
            ...
            for fileid in fileids_:
                ...
                dirname = os.path.join("/media/datasets/PascalVOC_outline/VOCdevkit", "VOC{}".format(year))
