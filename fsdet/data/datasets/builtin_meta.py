...
def _get_rfs_fewshot_instances_meta():
    ret = {
        "thing_classes": RFS_ALL_CATEGORIES,
        "novel_classes": RFS_NOVEL_CATEGORIES,
        "base_classes": RFS_BASE_CATEGORIES,
    }
    return ret
...
def _get_builtin_metadata(dataset_name):
    ...
    elif dataset_name == "rfs_fewshot":
        return _get_rfs_fewshot_instances_meta()
