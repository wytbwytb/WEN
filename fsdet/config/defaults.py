...
_C.MODEL.ROI_HEADS.FUSE_ALPHA = 0.3
_C.MODEL.ROI_HEADS.NOVEL_MODULE = CN()
_C.MODEL.ROI_HEADS.NOVEL_MODULE.INIT_FEATURE_WEIGHT = None
_C.MODEL.ROI_HEADS.NOVEL_MODULE.COPY_OPTION = False
_C.MODEL.ROI_HEADS.NOVEL_MODULE.BG_BOTTOM_K = 256
_C.MODEL.ROI_HEADS.NOVEL_MODULE.IOU_THRESH = 0.7
_C.MODEL.ROI_HEADS.NOVEL_MODULE.PROTOTYPES_FUSE_ALPHA = 0.3
_C.MODEL.ROI_HEADS.NOVEL_MODULE.PROTOTYPES_FEATURE_FUSE_ALPHA = 0.3
_C.MODEL.ROI_HEADS.NOVEL_MODULE.PROLOSS_FACTOR = 0.5
