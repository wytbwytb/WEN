...
class RFSDetectionEvaluator(DatasetEvaluator):
    """
    ...
    def __init__(self, dataset_name):
        ...
        self._anno_file_template = os.path.join(
            meta.dirname, "annotations", "{}.txt"
        )
        self._image_set_path = os.path.join(
            meta.dirname, meta.split + ".txt"
        )
        ...
        assert meta.year in [2021], meta.year
    ...
    def evaluate(self):
        ...
        with tempfile.TemporaryDirectory(prefix="rfs_eval_") as dirname:
