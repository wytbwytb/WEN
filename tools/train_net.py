...
import os
from fsdet.evaluation.rfs_evaluation import RFSDetectionEvaluator
...
if __name__ == "__main__":
    ...
    # args.config_file = 'configs/RFS/split1/5shot_GPB_PFB_proloss.yml'
    # args.num_gpus = 3
    # args.opts = ['MODEL.ROI_HEADS.NOVEL_MODULE.PROTOTYPES_FUSE_ALPHA', 0.1]
