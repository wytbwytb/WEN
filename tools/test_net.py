...
if __name__ == "__main__":
    ...
    # args.config_file = 'configs/RFS/split1/10shot_c.yml'
    # args.num_gpus = 3
    # args.eval_only = True
    # args.opts = ['MODEL.WEIGHTS', '/media/datasets/gpu17_models/Ours/checkpoints/rfs/faster_rcnn/split1_10shot_c/001_416.pth',
    #             'MODEL.ROI_HEADS.NOVEL_MODULE.INIT_FEATURE_WEIGHT', '/media/datasets/gpu17_models/Ours/checkpoints/rfs/faster_rcnn/split1_10shot_c/001_416.pkl']
