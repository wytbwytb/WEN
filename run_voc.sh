...
ROOT=/media/datasets/gpu17_models/WEN/checkpoints/voc/faster_rcnn #<- Change this yourself

#------------------------------ Base-training ------------------------------- #
for split in 1 2 3
do
    python tools/train_net.py --num-gpus 3 \
        --config-file configs/PASCAL_VOC/base-training/R101_FPN_base_training_split${split}.yml \
...
do
    ...
    do
        ...
        CONFIG_PATH=configs/PASCAL_VOC/split${split}/${shot}shot_GPB_PFB_proloss.yml
